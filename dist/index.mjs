...
function Root({ open: openProp, onOpenChange, children, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, shouldScaleBackground = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, nested, noBodyStyles = false, direction = 'bottom', defaultOpen = false, disablePreventScroll = true, snapToSequentialPoint = false, preventScrollRestoration = false, repositionInputs = true, onAnimationEnd, container, autoFocus = false }) {
    ...
    React__default.useEffect(()=>{
        var _window_visualViewport, // New: on some Android / WebViews with adjustPan, the keyboard pans via scroll
        // rather than resize, so we also watch scroll.
        _window_visualViewport1;
        function onVisualViewportChange() {
            if (!drawerRef.current || !repositionInputs) return;
            const focusedElement = document.activeElement;
            const isFocusedInsideDrawer = !!focusedElement && drawerRef.current.contains(focusedElement);
            // Only react if:
            ...
            if (isInput(focusedElement) && isFocusedInsideDrawer || keyboardIsOpen.current) {
                ...
                const visualViewportHeight = (visualViewport == null ? void 0 : visualViewport.height) || 0;
                const visualViewportOffsetTop = (visualViewport == null ? void 0 : visualViewport.offsetTop) || 0;
                ...
                if (snapPoints && snapPoints.length > 0 && snapPointsOffset && typeof activeSnapPointIndex === 'number') {
        ...
        (_window_visualViewport1 = window.visualViewport) == null ? void 0 : _window_visualViewport1.addEventListener('scroll', onVisualViewportChange);
        return ()=>{
            var _window_visualViewport, _window_visualViewport1;
            (_window_visualViewport = window.visualViewport) == null ? void 0 : _window_visualViewport.removeEventListener('resize', onVisualViewportChange);
            (_window_visualViewport1 = window.visualViewport) == null ? void 0 : _window_visualViewport1.removeEventListener('scroll', onVisualViewportChange);
        };
    }, [
        activeSnapPointIndex,
        snapPoints,
